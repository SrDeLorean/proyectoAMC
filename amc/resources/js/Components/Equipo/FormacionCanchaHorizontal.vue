<template>
  <div class="flex flex-col items-center mt-6 space-y-4 px-4">
    <!-- Cancha responsiva horizontal con aspecto 3:2 -->
    <div
      class="relative w-full max-w-[900px] aspect-[3/2] rounded-lg shadow-lg overflow-visible"
      :style="{
...
import fondo from '@/assets/cancha_horizontal.png' // Cambia a la imagen horizontal de tu cancha
...
const esTitular = (valor) => valor === 1 || valor === '1' || valor === true
...
// --- Coordenadas ajustadas para cancha horizontal (valores en % de top y left)
...
// Espejo horizontal de la posición X
const posicionX = (pos) => `${100 - (coordenadas[pos]?.[1] || 0)}%`
</script>
